 ...
 * 
 */
@WebServiceClient(name = "Calculator", targetNamespace = "http://service/", wsdlLocation = "http://localhost:8585/Calculator?wsdl")
    ...
    extends Service
{
    ...
    private final static QName CALCULATOR_QNAME = new QName("http://service/", "Calculator");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8585/Calculator?wsdl");
    ...
    public Calculateur getCalculateurPort() {
        return super.getPort(new QName("http://service/", "CalculateurPort"), Calculateur.class);
    }
    ...
    public Calculateur getCalculateurPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://service/", "CalculateurPort"), Calculateur.class, features);
    }
